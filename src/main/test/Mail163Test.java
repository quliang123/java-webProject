...
public class Mail163Test {
    public static void main(String[] args) throws Exception {
        //"quliang12345678@163.com"
        //"529075990@qq.com"
      //quliang12345678@163.com
        SendMsg("529075990@qq.com","","530422781@qq.com","小jj   你还干啥","猪脑子");

    }

    public static void SendMsg(String fromMail, String fromPwd, String toMail, String title, String content) throws MessagingException {
        //0.1 确定连接位置
        ...
        Authenticator authenticator = new Authenticator() {
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                ...
                return new PasswordAuthentication(fromMail, fromPwd);
            }
        };
