...
public class SortTest {
    ...
    public void testSave() throws IOException {
        happy.entity.Article article= new happy.entity.Article();
    ...
    public void search() throws IOException, ParseException, InvalidTokenOffsetsException {
       ...
       // System.out.println(count+"总记录数");
        ...
        for (int i=0;i<scoreDocs.length;i++){
            ...
            //把Document转化成Article
            happy.entity.Article article= AritcleDocumentUtils.documentToArticle(doc);
            list.add(article);
        }
        for (happy.entity.Article arti:list){
