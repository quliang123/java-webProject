...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <%--<form action="userServlet?action=modifyPwds">--%>
            ...
            <div>
                ...
                <span>*请输入新确认密码，保证和新密码一致${user.id}</span>
            </div>
            <div class="providerAddBtn">
                <!--<a href="#">保存</a>-->
                <input type="button" value="保存" onclick="modify(${user.id})"/>
                <script type="text/javascript">
                    function modify(id) {
                        var a = $("#reNewPassword").val();
